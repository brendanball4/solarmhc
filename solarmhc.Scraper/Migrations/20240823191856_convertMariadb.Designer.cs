...
namespace solarmhc.Scraper.Migrations
{
    ...
    [Migration("20240823191856_convertMariadb")]
    partial class convertMariadb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.InverterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.Model", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.PowerIntake", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.SolarSegment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.InverterType", b =>
                {
                    b.HasOne("solarmhc.Scraper.Models.Model", "Model")
                        .WithMany()
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.Model", b =>
                {
                    b.HasOne("solarmhc.Scraper.Models.Brand", "Brand")
                        .WithMany()
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.PowerIntake", b =>
                {
                    b.HasOne("solarmhc.Scraper.Models.SolarSegment", "SolarSegment")
                        .WithMany()
            ...
            modelBuilder.Entity("solarmhc.Scraper.Models.SolarSegment", b =>
                {
                    b.HasOne("solarmhc.Scraper.Models.InverterType", "InverterType")
                        .WithMany()
