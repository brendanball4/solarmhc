...
namespace solarmhc.Scraper
{
    public static class Constants
    {
        ...
        public static class DataUrls
        {
            ...
            public static class DataPages
            {
                public const string Sunny = "https://ennexos.sunnyportal.com/11382962/dashboard";

                public const string APSMain = "https://apsystemsema.com/ema/security/optmainmenu/intoLargeDashboard.action";
                public const string APSData = "https://apsystemsema.com/ema/security/optsecondmenu/intoViewOptModule.action";

                public const string Huawei = "https://huawei.frankensolar.ca:8443/securitys!tologin.action";
            }
        ...
        public static class TargetedElements
        {
            ...
            public static class APS
            {
                public static class Data
                {
                    public const string kwId = "div#module0";
                }
